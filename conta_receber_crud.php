    ...
    switch ($_POST["acao"]) {
        ...
        case 'grafico':
            try {
                ...
                $sql = "select extract(month from data_vencimento) as mes, sum(valor)
                 as valor from conta_receber where usuario_id = ? 
                    and extract(year from data_vencimento) = ?  group by mes order by mes";
