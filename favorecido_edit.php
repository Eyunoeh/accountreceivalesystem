                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#" title="Home" id="home_index_favorecido"><i class="fas fa-home"></i>
                                    <span>Home</span></a></li>
                            <li class="breadcrumb-item"><a href="#" title="Favorecido" id="favorecido_index"><i class="fas fas fa-tag"></i> <span>Payer</span></a></li>
                ...
                <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="favorecido_dados" role="form" action="">
                    ...
                    <div class="tab-content" id="tabdados_favorecido">
                        <div class="tab-pane fade show active" id="dados_favorecido" role="tabpanel" aria-labelledby="dados_favorecido">
                            <div class="col-md-6">
                                <label for="nome_favorecido" class="form-label">Name</label>
                    ...
                    <br>
                    <div>
                        <button type="button" class="btn btn-primary" id="botao_salvar_favorecido">Save</button>
                        <button type="reset" class="btn btn-secondary" id="botao_limpar_favorecido">Clear</button>
                    </div>
                </form>
            </div>
            <div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="modal_salvar_sim_favorecido">Yes</button>
