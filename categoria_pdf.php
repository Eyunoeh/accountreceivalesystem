...
class CategoriaPDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Title
        $this->Cell(30, 10, 'List of Categories', 0, 0, 'C');
    ...
    function Footer()
    {
        ...
        // Page number
        $this->Cell(0, 10, iconv("utf-8", "cp1252", "Page: ") . $this->PageNo() . "/{nb}", 0, 0, "C");
        $this->Cell(0, 10, iconv("utf-8", "cp1252", "Date: ") . date("d/m/Y - H:i:s"), 0, 0, "R");
    }
